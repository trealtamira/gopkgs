...
const CHAT_ENDPOINT = "https://chat.googleapis.com/v1/spaces/AAAAmyEtxvE/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=buBq5m4xvB53bSsempbbVklNYtnOwnwbLfgfmWn0RWc%3D"
...
func sendChatJSON(message string) error {
	resp, err := http.Post(CHAT_ENDPOINT, "application/json", strings.NewReader(message))
	if err != nil {
